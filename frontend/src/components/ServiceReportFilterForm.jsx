...
const ServiceReportFilterForm = ({ onFilter }) => {
  ...
  if (usuario.rol === "admin") {
    ...
    setTecnico(true);
    setFilters({ ...baseFilters, tecnicoId: usuario.id });
  } else if (usuario.rol === "cliente") {
    setCliente(true);
    setFilters({ ...baseFilters, clienteId: usuario.id });
  }
}, [usuario]);
  ...
  return (
    ...
    >
      ...
      {/* Identificación (solo admin/técnico) */}
      {(admin || tecnico) && (
        <div className="flex flex-col w-full">
...
export default ServiceReportFilterForm;
