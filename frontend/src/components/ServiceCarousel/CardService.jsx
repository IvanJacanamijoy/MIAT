...
const CardService = ({ titulo, descripcion, imageUrl, textoBoton }) => {
    return (
        <div className="bg-red-600 max-w-72 rounded-xl shadow-lg overflow-hidden  duration-300 hover:shadow-xl mx-auto">
            <div className="h-full flex flex-col">
                ...
                <div className="p-8 min-h-72 flex flex-col justify-between">
                    ...
                    <button className="px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-900 mx-auto">
                        {textoBoton}
                    </button>
                </div>
            </div>
