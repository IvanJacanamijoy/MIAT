  ...
  return (
    <>
      ...
      <button
        ...
        className="absolute left-4 top-1/2 z-10 bg-black rounded-full p-2 bg-black/70 shadow-md hover:bg-black transition-colors"
      >
      ...
      <button
        ...
        className="absolute right-4 top-1/2 -traslate-y-1/2 z-10 bg-black rounded-full p-2 bg-black/70 shadow-md hover:bg-black transition-colors"
      >
        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
